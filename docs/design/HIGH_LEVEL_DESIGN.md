...
The vehicle needs fused 12 V-to-5 V conversion, stable ground, secure enclosure/cabling, a clear-sky antenna, and cellular/Wi-Fi access. Secure Boot V2, flash encryption, and signed OTA/rollback are deployment operations and intentionally cannot be safely auto-enabled by repository code.

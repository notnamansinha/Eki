...
| Device receives 400 | Exact eight-field payload, JSON size, ranges, sequence, and capture/send timestamps | [API device endpoints](../backend/API.md#device-endpoints) |
